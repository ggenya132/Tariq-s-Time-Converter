...
public class Model {
    ...
    public String buildTimeIntoString(String[] timeInputStringArray) throws InvalidTimeException {

        StringBuilder stringBuilder = new StringBuilder();
        Pattern pattern = Pattern.compile("\\s");
        Matcher matcher = pattern.matcher(timeInputStringArray[1]);
        String amOrPm = "";
        if (matcher.find()) {
            amOrPm = timeInputStringArray[1].substring(2, timeInputStringArray[1].length());
            timeInputStringArray[1] = timeInputStringArray[1].substring(0, 2);
        } else {
            amOrPm = timeInputStringArray[1].substring(2, timeInputStringArray.length);
            timeInputStringArray[1] = timeInputStringArray[1].substring(0, 2);
        }

        if (Integer.parseInt(timeInputStringArray[0]) > 12 | Integer.parseInt(timeInputStringArray[1]) > 60 | Integer.parseInt(timeInputStringArray[0]) < 0 | Integer.parseInt(timeInputStringArray[1]) < 0) {
    ...
    public String buildTimeIntoStringMilitary(String[] timeInputStringArray) throws InvalidTimeException {
        StringBuilder stringBuilder = new StringBuilder();

        switch (timeInputStringArray[0]) {

            case ("00"):
                stringBuilder.append("zero zero");
                break;
            case ("01"):
                stringBuilder.append("zero one");
                break;
            case ("02"):
                stringBuilder.append("zero twp");
                break;
            case ("03"):
                stringBuilder.append("zero three");
                break;
            case ("04"):
                stringBuilder.append("zero four");
                break;
            case ("05"):
                stringBuilder.append("zero five");
                break;
            case ("06"):
                stringBuilder.append("zero six");
                break;
            case ("07"):
                stringBuilder.append("zero seven");
                break;
            case ("08"):
                stringBuilder.append("zero eight");
                break;
            case ("09"):
                stringBuilder.append("zero nine");
                break;
            case ("10"):
                stringBuilder.append("ten");
                break;
        ...
        stringBuilder.append("hundred hours");

        if (timeInputStringArray[0].equals("00") && timeInputStringArray[1].equals("00")) {
